...
from computeEvaltool.constants import EvalBackend, EvalStage, EvalType, JudgeStrategy, ModelTask, OutputType
...
def add_argument(parser: argparse.ArgumentParser):
    ...
    parser.add_argument('--datasets', type=str, nargs='+', required=False, help='Dataset id list, align to the module name in computeEvaltool.benchmarks')  # noqa: E501

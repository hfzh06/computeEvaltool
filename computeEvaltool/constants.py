...
os.environ['COMPUTEEVALTOOL_LOG_LEVEL'] = '40'  # Set default log level to ERROR

# from computeEvaltool.utils.constant import DEFAULT_REPOSITORY_REVISION
...
DEFAULT_DATASET_CACHE_DIR = "~/.cache/modelscope/datasets"
DEFAULT_ROOT_CACHE_DIR = DEFAULT_DATASET_CACHE_DIR

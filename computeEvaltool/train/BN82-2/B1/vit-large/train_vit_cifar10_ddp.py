...
def parse_args():
    ...
    parser.add_argument("--save-dir", default="/data/checkpoints")
...
def main():
    ...
    train_dataset = torchvision.datasets.CIFAR10(
        root=args.data_path, train=True, download=False, transform=train_tf
    )
    val_dataset = torchvision.datasets.CIFAR10(
        root=args.data_path, train=False, download=False, transform=val_tf
    )

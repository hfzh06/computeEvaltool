...
SAVE_DIR="/data/megatron_output/deepseek-ocr-lora"
RESULT_DIR="/root/computeEvaltool/train/B3/results"
OUTPUT_XLSX="${RESULT_DIR}/training_deepseek7B_1.xlsx"
...
megatron sft \
    ...
    --dataset '/data/datasets/openr1_math_220k.jsonl' \
    --train_type lora \
    --lora_rank 8 \
    --model_type qwen2 \
    --lora_alpha 32 \

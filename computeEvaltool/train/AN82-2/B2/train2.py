...
def run_model(model, config_dict, hidden_dim, dtype, include, pin_memory, non_blocking, iteration, warmup,args):
...
def main():
    ...
    parser.add_argument("--model_name_or_path", type=str, default="/root/computeEvaltool/train/deepseek-7b-chat")
    ...
    run_model(model, config_dict, hidden_dim, dtype, included_state, args.pin_memory, args.non_blocking, args.iteration, args.warmup,args)
